...
- Categories: VI. Physics and Simulation (Fluid SPH/FLIP/Eulerian, Deformable FEM/Projective Dynamics, Rigid Body, Crowd/Multi-Agent, Fracture/Destruction, Rope/Cable, GPU Cloth, Fluid-Solid Coupling, Granular DEM, Hydraulic Erosion, Fluid Surface Extraction, CCD, Minkowski Sum/Motion Planning), VII. SDF and Volumetric Methods (Level Set Methods, Swept Volumes/Minkowski Sums, TSDF Fusion/3D Reconstruction, SDF Collision, Isosurface Extraction, GPU AO, Volumetric Ray Marching, Sparse Narrow-Band Level-Set)
- Integrations: Ch208 (metaball and SDF surface representations as input/output), Ch209 (spatial structures for physics broadphase), Ch206 (shader algorithms for fluid surface rendering), Ch133 (async compute scheduling for physics dispatches)
