...
- Integrations: Ch210 (physics simulation; Newton-Raphson and ADMM contact solves consume this chapter's sparse linear solvers), Ch114 (SLAM pose-graph sparse Cholesky via CHOLMOD/cuDSS), Ch221 (GPU performance), Ch224 (shape analysis eigensolver), Ch225 (topology sparse Laplacian), Ch227 (Monte Carlo sampling using LA), Ch229 (ML inference GEMM)
