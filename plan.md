...
- Integrations: Ch154 (GPU-driven rendering — Cat I implementation), Ch127 (mesh shaders and VRS — Cat I hardware), Ch135 (Vulkan RT — shadow ray queries in Cat III), Ch24 (Vulkan pipeline objects), Ch205 (GI and material algorithms that build on these pipeline configurations)
...
- Integrations: Ch204 (pipeline configurations), Ch206 (RT extensions of GI), Ch135 (path-traced lightmap baking), Ch208 (subdivision/NURBS geometry feeding PBR pipeline)
