...
- Scope: frameworks that embed reinforcement-learning or LLM-driven agents into games/engines, distinct from the general-purpose robotics simulators in Ch211a and the NVIDIA Isaac/GR00T stack in Ch69/Ch240
...
- **Integrations**: Ch40 (Bevy and wgpu — `bevy_rl`'s render-loop integration); Ch41 (Godot 4 RenderingDevice — Godot RL Agents' engine-side plugin); Ch69 (Omniverse/PhysX/GR00T — Isaac Lab as the equivalent large-scale robotics-training path); Ch211a (MuJoCo MJX — the robotics-physics analog of Craftax's JAX-vectorized GPU architecture); Ch240 (Isaac Sim/GR00T synthetic-data generation at scale); Ch124 (Local LLM Inference — the serving stack behind AI Town's Ollama-backed NPCs)
