# Chapter 244c: Open-Source 2D Simulation-Game Engines: Sprite Blitters, GPU Batching, and Reimplementation Modding
...
The recurring lesson is that each project separated *declarative content* from *imperative behaviour* and used different technology for each. None chose a single language for both. Chapter 244d takes up the general design space these three points sit within.
