...
- How USD composes scene description from multiple layers via LIVERPS arcs
- The Hydra rendering delegate abstraction and how the RTX Renderer implements it
- Slang's role as a differentiable shading language and its relationship to PTX/SPIR-V compilation
- Multi-GPU work distribution in Omniverse
- Practical deployment of headless Kit applications on Linux, including container workflows
