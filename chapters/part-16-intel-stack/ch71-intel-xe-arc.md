...
**Arc Alchemist (2022)** — Intel's first consumer discrete GPU line uses Xe-HPG on TSMC N6. The flagship A770 carries 32 Xe-cores (4,096 shader units), 32 ray-tracing units (RTUs), and 16 GB GDDR6. Alchemist introduced hardware AV1 decode and encode, a requirement for modern streaming workloads.
