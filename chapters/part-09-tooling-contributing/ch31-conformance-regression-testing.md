...
- **dEQP / VK-GL-CTS**: Khronos-maintained conformance tests for Vulkan, OpenGL, OpenGL ES, and EGL.
- **IGT GPU Tools**: The primary test suite for Linux DRM kernel drivers, covering KMS, GEM, DMA-BUF, and synchronisation objects.
